    ...
    return (
            ...
            <div className={this.state.hiding.class}></div>
              ...
              <nav className="navbar fixed-top navbar-custom bg-light">
                ...
                <div className="navbar-brand" href="#"> <img src={this.defaultProps.poster} width='45'height='45'/>
                  <span className="highLight">NYC Houspector</span> </div>
                    ...
                    <ul className="list-group">
                      ...
                      <div className="row">
                        ...
                        <div className="col-sm-6">
                           ...
                           <li key={index+=3} className="list-group-item"><span className="bold">Date of Inspection</span> {":  "}{house.inspectiondate}
                           </li>
                        ...
                        <div className="col-sm-6">
                          <li key={index+=5} className="list-group-item"><span className="bold">Violation{": "}</span> {house.novdescription}
                          </li>
                          <li key={index+=6} className="list-group-item list-group-item-info"><span className="bold">Current Status</span> {":  "}{house.currentstatus}
                         </li>
                        </div>
