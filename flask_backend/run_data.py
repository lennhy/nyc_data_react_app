...
results = client.get('b2iz-pps8', limit=2000 , order='violationid ASC', offset="{0}".format(data['count'][0]), where="approveddate between '{0}' and '{1}'".format(earlier_date, today))
